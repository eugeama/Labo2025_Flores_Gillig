...
void RegistroPacientes (vector<Paciente> &pacientes) {
...
for (int i = 0; i < cantidad_pacientes; i++) {
    ...
    cout << "Ingrese año de la próxima cita: ";
    cin >> paciente.proxima_cita.anio;
    bool aux= false;
    paciente.cancelado=aux;
...
void BuscarInfo (vector<Paciente> pacientes) {
    int num_historia;
